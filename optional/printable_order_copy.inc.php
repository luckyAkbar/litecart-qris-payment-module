    ...
    <?php if (count($order['items']) <= 10) { ?>
        <footer class="footer">
            ...
            <div class="row">
                ...
                <div class="col-xs-3">
                    <div class="label"><?php echo language::translate('title_qris_code', 'Store QRIS Code'); ?></div>
                    <div class="value"><a href="<?php echo document::ilink('qris'); ?>"><?php echo document::ilink('qris'); ?></a></div>
                </div>
